/* ---------------------------------------------------------
   Pedido de orçamento de treinamento
...
(function () {
  ...
  var form = document.getElementById('formTreinamento');
  if (!form) return;

  var btn = document.getElementById('btnTreinamento');
  var aviso = document.getElementById('formTreinamentoAviso');
  var ok = document.getElementById('formTreinamentoOk');
  ...
  function validar() {
    ...
    [['nome', 'Informe seu nome.'],
     ...
     ['local', 'Informe a cidade e o local do treinamento.'],
     ['tema', 'Conte quais módulos interessam.']
    ...
    if (!email.value.trim()) {
      mostrarErro(email, 'Informe o e-mail — é para lá que vai o orçamento.');
      erros.push(email);
